...
URL = "https://check-ffwb.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://check-ffwb.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://check-ffwb.onrender.com/".format(FQDN)
else:
    URL = "https://check-ffwb.onrender.com/".format(FQDN)
