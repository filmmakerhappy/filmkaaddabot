...
URL = "https://fuzzy-jessalyn-filmmakerhappy.koyeb.app".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://fuzzy-jessalyn-filmmakerhappy.koyeb.app/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://fuzzy-jessalyn-filmmakerhappy.koyeb.app/".format(FQDN)
else:
    URL = "https://fuzzy-jessalyn-filmmakerhappy.koyeb.app/".format(FQDN)
